                                            ...
                                            <?php foreach ($data_mahasiswa as $mahasiswa) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center" width="20%">
                                                        ...
                                                        <a href="hapus-mahasiswa.php?id_mahasiswa=<?= $mahasiswa['id_mahasiswa']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda Yakin ingin menghapus data Mahasiswa ini?')"><i class="fas fa-trash-alt"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
